...
| Period       | Tech                                                   | Notes                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| ------------ | ------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 2025-present | **Applied AI Engineering**                             | Mostly fresh startups in the GenAI industry, using a variety of coding agents and cloud tools on every step of [SDLC](https://en.wikipedia.org/wiki/Systems_development_life_cycle "System development life cycle"). [Claude Code](https://claude.com/product/claude-code), [Codex](https://openai.com/codex/), [Cursor](https://cursor.com), [pi](https://pi.dev), [Gemini CLI](https://geminicli.com), [MiMo Code](https://mimo.xiaomi.com/coder)                |
| 2024-present | [Go](https://go.dev)                                   | Fintechs, microservices over event-driven architectures, real-time data processing when paired with [Apache Kafka](https://kafka.apache.org)/[RabbitMQ](https://www.rabbitmq.com)/[NATS](https://nats.io), using [Gin](https://gin-gonic.com)/[Chi](https://go-chi.io) for HTTP services, [sqlx](https://github.com/jmoiron/sqlx)/[GORM](https://gorm.io) for SQL/RDBMSes, [Cobra](https://cobra.dev) for CLI, and surely [PostgreSQL](https://www.postgresql.org) |
